                                ...
                                <g:form name="placeInfo" action="updatePlace" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="text" class="form-control" id="plceName" name="placeName" placeholder="Place Name" value="${place.placeName}">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <textarea class="form-control" id="placeDescription" name="placeDescription" placeholder="Place Description" rows="3" >${place.description}</textarea>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="text" class="form-control" id="placePhone" name="placePhone" placeholder="Place Phone" value="${place.telephone}">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="email" class="form-control" id="placeEmail" name="placeEmail" placeholder="Place Email" value="${place.email}">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="url" class="form-control" id="placeWebsite" name="placeWebsite" placeholder="Place Website" value="${place.website}">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <textarea class="form-control" id="placeIndications" name="placeIndications" placeholder="Place Indications" rows="3" >${place.indication}</textarea>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <textarea class="form-control" id="placeAdditional" name="placeAdditional" placeholder="Place Additional" rows="3" >${place.additionalInfo}</textarea>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Latitude" value="${place.latitude}">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Longitude" value="${place.longitude}">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="text" class="form-control" id="altitude" name="altitude" placeholder="Altitude" value="${place.altitude}">
                                      </div>
                                    </div>
                                    ...
                                    <g:hiddenField name="idPlace" id="idPlace" value="${place.id}"/>
